module.exports = (email) => {
  return `
    ...
    <title>New email template 2022-07-07</title><!--[if (mso 16)]>
    <style type="text/css">
    ...
    <![endif]-->
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" background="https://vojdsp.stripocdn.email/content/guids/CABINET_6c7b2f5b32978d89c268e7ceeb7bad21/images/group_63_61d.png" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-image:url(https://vojdsp.stripocdn.email/content/guids/CABINET_6c7b2f5b32978d89c268e7ceeb7bad21/images/group_63_61d.png);background-repeat:no-repeat;background-position:center top">
    <tr>
    <td valign="top" style="padding:0;Margin:0">
    <table cellpadding="0" cellspacing="0" class="es-header" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:transparent;background-repeat:repeat;background-position:center top">
    <tr>
    <td align="center" style="padding:0;Margin:0">
    <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;border-radius:20px 20px 0 0;width:650px">
    <tr>
    <td align="left" style="padding:20px;Margin:0"><!--[if mso]><table style="width:610px" cellpadding="0"
    ...
    </table><!--[if mso]></td><td style="width:20px"></td><td style="width:385px" valign="top"><![endif]-->
    ...
    <tr>
    <td style="padding:0;Margin:0;border-bottom:2px solid #5f3c5e;background:none;height:1px;width:100%;margin:0px"></td>
    </tr>
    </table></td>
    </tr>
    </table></td>
    ...
    <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace:0pt;width:100%;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
    <tr>
    ...
    <tr>
    <td align="center" style="padding:0;Margin:0">
    <table class="es-footer-body" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;border-radius:0 0 10px 10px;width:650px">
    <tr>
